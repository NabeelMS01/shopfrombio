      ...
      <Card>
        ...
        <CardContent className="space-y-8">
          <div className="grid gap-3">
            ...
            <Input id="name" name="name" type="text" defaultValue={store.name} />
            {state.errors?.name && <p className="text-sm text-destructive">{state.errors.name[0]}</p>}
          </div>
          <div className="grid gap-3">
            <Label htmlFor="subdomain">Subdomain</Label>
            <div className="flex items-center">
              <Input id="subdomain" name="subdomain" type="text" defaultValue={store.subdomain} />
          ...
          <div className="grid gap-3">
            ...
            <RadioGroup name="theme" defaultValue={store.theme} className="flex flex-wrap gap-4">
              <div>
